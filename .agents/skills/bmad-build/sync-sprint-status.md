...
- `story_key` is unset
- `{{config.modules.bmm.implementation_artifacts}}/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `{{config.modules.bmm.implementation_artifacts}}/sprint-status.yaml` file.
