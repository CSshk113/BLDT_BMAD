    ...
    <Card>
      ...
      <CardContent className="grid gap-2">
        ...
        {items.map((item) => {
          ...
          return <Button key={item.id} type="button" variant={selectedId === item.id ? "secondary" : "outline"} className="h-auto justify-between gap-3 py-3 text-left" onClick={() => onSelect(item.id)}>
